...
$result_albums_beauty = $connect->prepare($albums_beauty);
$result_albums_beauty->execute();
$statement_albums_beauty = $result_albums_beauty->fetchAll();
...
$result_albums_beauty1 = $connect->prepare($albums_beauty1);
$result_albums_beauty1->execute();
$statement_albums_beauty1 = $result_albums_beauty1->fetchAll();
...
<div class="container">
  <div class="container gallery-container" style="margin-top: 70px;">
    <h4 class="text-center">Beauty Panel</h4>
    <!-- <p class="page-description text-center">Grid Layout With Zoom Effect</p> -->
    
    <div class="">
      <div class="row mb-3">

        <?php foreach($statement_albums_beauty as $ab){?>
        <div class="col-md-3 column" style="margin-top: 30px;">
          <!-- <div class="card"> -->
          <form action="" method="post">
          	
          	<button class="btn btn-danger btn-sm" type="button" name="delete_beauty[]" style="float: right;" data-toggle="modal" data-target="#exampleModalCenter<?=$ab['title']?>">X</button>
            <button class="btn btn-warning btn-sm" type="button" name="transfer_beauty_album[]" style="float: left;" data-toggle="modal" data-target="#exampleModalBeauty<?=$ab['title']?>">Transfer</button>
          	<!-- <button class="btn btn-success" type="submit" name="edit[]" style="float: right;">Edit</button> -->
          </form>



          <div class="modal fade" id="exampleModalBeauty<?=$ab['title']?>" tabindex="-1" role="dialog"
          aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="true">
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Are you sure you want to transfer <i><?=$ab['title']?></i> album?</h5>
              ...
              <div class="modal-body">
                ...
                <form action="update_remove.php?msg=<?=encodeURIComponent($ab['title'])?>" method="post">
            ...
            <?php
                      foreach ($statement_albums_beauty1 as $sab1){
                        ?>
                      
                     <option value="<?=$sab1['m_id']?>" <?php if($ab['panel_id']==$sab1['m_id']){echo 'selected'; }?>><?=$sab1['menu_name']?></option> 
              ...
              <div class="modal-footer bg-whitesmoke br">
                ...
                <button type="submit" class="btn btn-primary" name="yes_transfer_album_beauty[]">Transfer</button>
              </form>
            <?php //}
              ?>
          ...
          <div class="modal fade" id="exampleModalCenter<?=$ab['title']?>" tabindex="-1" role="dialog"
          aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="true">
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Are you sure you want to remove <i><?=$ab['title']?></i> album permanently?</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              ...
              <div class="modal-footer bg-whitesmoke br">
                ...
                <button type="submit" class="btn btn-primary" name="yes_album_beauty[]">Yes</button>
              </form>
            <?php //}
              ?>
                <button type="button" style="background-color: red" class="btn btn-secondary" name="no[]" data-dismiss="modal">No</button>
            ...
            <a class="lightbox cols" href="cpanel_album_inside.php?msg=<?=encodeURIComponent($ab['title'])?>">
              <img src="<?=$ab['picture']?>" alt="" class="card-img-top">
           </a>
            <a href="cpanel_album_inside.php?msg=<?=encodeURIComponent($ab['title'])?>"><div class="middle">
    <div class="text"><?=$ab['title']?></div>
  </div></a>
          <!-- </div> -->
        </div>
        <?php }?>
